...
//  'joe' is invoked to then create an object that is referred to as 'this' whenever the function is called.

// 2. What is "this" when joe.scopeArrow() is invoked?
// It doesn't exist because 'this' losses its context, nothing fills its place.

// 3. Explain why "this" is different when an arrow function is used.
// When an arrow functions is used 'this' losses its ability to be called into a constructor creating a new object of whatever 'this' was filling in for. The reason is because 'this' stays fixed to whatever global object is referring too. In the browser it is 'window'.
